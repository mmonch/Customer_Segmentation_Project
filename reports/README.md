...
**Structure of the document:** The report summarizes the approach. The steps in detail for each method can be found in the related notebook.
...
- [transactor](https://www.creditcards.com/credit-card-news/glossary/term-transactor/)